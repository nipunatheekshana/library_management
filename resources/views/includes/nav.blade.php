<div class="uk-card  uk-card-body nav uk-light uk-padding-small" style="z-index: 980;" uk-sticky="bottom: #offset">
    ...
    <div class="user uk-text-large uk-margin-medium-right"><a href="">My books</a></div>
    <div class="user uk-text-large uk-margin-medium-right"><a href="">All books</a></div>
